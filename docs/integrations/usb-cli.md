...
The host must have a route to the USB-network interface, and the device firmware must expose the CLI. The default address is `usb.DefaultAddress`, currently `10.0.4.20:23`.
